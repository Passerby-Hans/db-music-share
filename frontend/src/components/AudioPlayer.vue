...
const MODE_META: Record<PlayMode, { label: string; paths: string[] }> = {
  // 列表循环：双箭头环
  list: {
    label: '列表循环',
    paths: [
      ...
      <div class="btns">
        <el-tooltip :content="modeMeta.label" placement="top">
          <el-button circle class="mode-btn" :aria-label="modeMeta.label" @click="player.cycleMode()">
            <svg class="mode-ic" viewBox="0 0 1024 1024" aria-hidden="true">
